...
if __name__ == '__main__':
    ...
    B_values = np.linspace(1000, 10000, 10)
    experiment = ExperimentRunner(cluster_optimizer, B_values)

    # experiment.run()

    # # Save the results
    # experiment.save_results("test_10.pkl")

    # Load the results (to demonstrate)
    experiment.load_results("test_10.pkl")
    ...
    # plotter.plot_total_accuracy(cluster_index = 1)
    ...
    # A_fitter = Fitter(experiment.results[1], cluster_optimizer.clusters[1])
